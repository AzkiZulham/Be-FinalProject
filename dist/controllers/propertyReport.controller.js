...
exports.getRoomTypesByProperty = exports.getTenantProperties = exports.getPropertyReport = void 0;
...
const getTenantProperties = async (req, res) => {
    try {
        const tenant = req.user;
        if (!tenant)
...
const getRoomTypesByProperty = async (req, res) => {
    try {
        const tenant = req.user;
        if (!tenant)
            return res.status(401).json({ error: "Unauthorized" });
